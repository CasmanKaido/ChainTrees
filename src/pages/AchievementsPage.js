...
export class AchievementsPage {
  constructor(containerId) {
    ...
    this.badges = [
      { id: 1, name: 'First Seed', description: 'Plant your first tree', icon: '🌱', rarity: 'Common' },
      { id: 2, name: 'Forest Keeper', description: 'Own 5 or more trees', icon: '🌲', rarity: 'Rare' },
      { id: 3, name: 'Green Thumb', description: 'Water your trees 10 times', icon: '💧', rarity: 'Common' },
      { id: 4, name: 'Carbon Neutral', description: 'Offset 1 ton of CO2', icon: '🌍', rarity: 'Epic' },
      { id: 5, name: 'Ancient Guardian', description: 'Grow a tree to Ancient stage', icon: '🧙‍♂️', rarity: 'Legendary' }
    ];
  }
  ...
  renderBadges(badgeData) {
    ...
    grid.innerHTML = badgeData.map(badge => {
